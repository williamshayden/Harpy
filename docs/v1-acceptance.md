...
are complete for the stated Linux/WSL Python 3.12 scope. The revision remains
**Unreleased**. See [the qualification record](verification/2026-09-08-v1-respec-qualification.md)
...
Only seed 0 ships with the package. Complete saved results and seed-1/2 artifacts
remain local; a fresh clone alone cannot reproduce the full historical studies.
The old tag stays intact. This checklist does not authorize publishing or tagging.
